...
/* crypto */
int es256_verify_sig(const fido_blob_t *, const br_ec_public_key *,
    const fido_blob_t *);
int rs256_verify_sig(const fido_blob_t *, const br_rsa_public_key *,
    const fido_blob_t *);
int rs1_verify_sig(const fido_blob_t *, const br_rsa_public_key *,
    const fido_blob_t *);
